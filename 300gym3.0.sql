...
use 300gym;
/*nota: no exportar el script, ya que el orden cambia y al momento de la creacion no existen llaves foraneas*/
/*Realizar cambios con este archivo, de ahi cambiar la version a continuación*/
...
CREATE TABLE entrenador (
  ...
  sexo_entrenador varchar(9) NOT NULL,
  ...
  Fotografia_entrenador varchar(300) NOT NULL,
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, INDEX, ALTER, CREATE TEMPORARY TABLES, CREATE VIEW, EVENT, TRIGGER, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE, EXECUTE ON 300gym.* TO admin@localhost;
